...
This is a set of Dockerfiles to generate a CentOS based Docker Image with the
ncat utility installed.  You can find more about these two projects on their
own pages:
...
Please ensure that you build an Docker Image to test your new Dockerfile:
 docker build -t tafthorne/ncat-centos -f ./Dockerfile .
